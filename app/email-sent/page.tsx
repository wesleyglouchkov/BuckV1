      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-[#e0f2fe] via-[#bae6fd] to-[#7dd3fc] dark:from-[#0c4a6e] dark:via-[#075985] dark:to-[#0369a1] relative overflow-hidden">
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          ...
          <div className="mt-12 relative">
            <div className="w-32 h-24 bg-white/30 dark:bg-white/20 transform rotate-3 absolute -right-4 -top-2"></div>
            <div className="w-32 h-24 bg-white/40 dark:bg-white/30 transform -rotate-3 relative flex items-center justify-center">
              <Mail className="w-12 h-12 text-gray-700 dark:text-white" />
            </div>
          </div>
        </div>
      </div>
